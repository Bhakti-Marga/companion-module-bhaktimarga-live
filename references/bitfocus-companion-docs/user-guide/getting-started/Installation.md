# Installation options and Instructions | Bitfocus Companion
...
We recommend using the CompanionPi images available with [our CompanionPi setup guide](http://127.0.0.1:8000/user-guide/getting-started/companion-pi)
...
If you want a headless version, we recommend using our install script to get a CompanionPi like environment. Read more on the [manual installation](http://127.0.0.1:8000/user-guide/getting-started/companion-pi/manual-install) page.
