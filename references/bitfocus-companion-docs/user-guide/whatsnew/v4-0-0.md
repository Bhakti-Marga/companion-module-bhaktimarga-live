# Companion v4.0.0 | Bitfocus Companion
...
![Module Management Interface](/user-guide/assets/images/module-management-a0123a8da9df2ea76f38cd94221d5947.png) *The new module management interface allows you to browse, install, and update modules independently from Companion*
...
- Support HTTP\_PROXY environment variables for module store api calls
