# Expressions | Bitfocus Companion
...
Expressions can contain *number literals*, *custom variables*, *dynamic variables*, *operators*, *functions*, *ternaries* and *template strings*.
...
```
myval = $(custom:a) + $(custom:b)myval / 2
```
...
```
/* block comment */// end of line comment
```
